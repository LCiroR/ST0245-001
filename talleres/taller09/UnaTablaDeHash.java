/**
* La clase UnaTablaDeHash, es una plantilla para crear nuestra propia estructura hash
...
public class UnaTablaDeHash
{
   ...
   * de manera eficiente, por lo cual esta primera versión de hash no implementa colisiones
   */
   private int[] tabla;
   /**
